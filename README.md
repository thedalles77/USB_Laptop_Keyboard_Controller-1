# This was forked from Marcel Hillesheim's USB_Laptop_Keyboard_Controller repo and then the Teensy 4.1 and 2.0++ were added. The KMK folder contains a Python program and PDF that describes how to make a key matrix for the Raspberry Pi Pico and Solder Party 2350 Stamp XL.
