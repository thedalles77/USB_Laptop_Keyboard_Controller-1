# This was forked from Marcel Hillesheim's USB_Laptop_Keyboard_Controller repo and then the Teensy 4.1 was added
For suggestions and comments, contact Frank Adams at [thedalles77@gmail.com](thedalles77@gmail.com).

1. Load the "Matrix_Decoder_LC, _3p2, 4p0, or 4p1" code into your Teensy.
...
7. Use your mouse to set the cursor to the right of the very first key in the list. Wait about 20 seconds, then push each key listed in the text file. You should see pin number pairs as you push a key.
